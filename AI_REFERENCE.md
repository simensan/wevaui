...
_Last verified: 2026-09-15 (1.0.0); Native EditMode 234 pass / 2 environment-gated
inconclusive, full EditMode 235 pass / 2 inconclusive._
...
- **`Tools/oracle/run_chrome_checks.py`** — scripted behaviour checks
  ...
  discovery/imports/font sources/colors/scroll containers). Review: 65 scripts, 64 pass and 1 documented Chrome IME failure.
