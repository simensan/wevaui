...
```sh
node godot-port/tools/oracle/check_number_steps_chrome.cjs godot-port/hosts/godot/project/number_step_cases.json
python godot-port/tools/oracle/generate_number_step_fixture.py
```
