...
$env:WEVA_INCREMENTAL_CORPUS = (Resolve-Path godot-port/tools/oracle/corpus/samples).Path
...
WEVA_INCREMENTAL_CORPUS="$PWD/godot-port/tools/oracle/corpus/samples" \
