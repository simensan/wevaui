...
`filter_data.py` verifies the original data hash and repackages 13 unmodified
resources for root/English collation and character boundaries: 1,278,800 bytes.
