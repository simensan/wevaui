...
```powershell
node Tools/Layout/capture-all-chrome-layouts.mjs godot-port/tools/oracle/regressions/inline-bounds 800 600 --metrics=mono
python godot-port/tools/oracle/chrome_sweep.py godot-port/tools/oracle/regressions/inline-bounds --weva-dump <weva_dump.exe> --width 800 --height 600 --chrome-metrics --out-dir .utmp/inline-bounds
```
