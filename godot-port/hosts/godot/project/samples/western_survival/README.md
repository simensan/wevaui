...
```sh
godot --path godot-port/hosts/godot/project --resolution 1440x810 --scene res://samples/western_survival/survival.tscn
```
...
```sh
godot --headless --path godot-port/hosts/godot/project --script res://samples/western_survival/survival_smoke.gd
godot --path godot-port/hosts/godot/project --rendering-method gl_compatibility --script res://samples/western_survival/survival_smoke.gd
godot --path godot-port/hosts/godot/project --rendering-method gl_compatibility --script res://samples/western_survival/survival_bench.gd
