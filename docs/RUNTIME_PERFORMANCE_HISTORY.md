# Runtime performance history

These are earlier build-specific measurements. References to “current” or
“installed” mean the checkpoint being described. Use [runtime performance](RUNTIME_PERFORMANCE.md)
for the latest measurements. Original results and failed evidence are retained.
...
```powershell
python hosts/godot/run_game_ui_bench.py `
