...
```powershell
node Tools/Layout/capture-all-chrome-layouts.mjs Tools/oracle/regressions/grid 800 600 --metrics=mono
python Tools/oracle/chrome_sweep.py Tools/oracle/regressions/grid --weva-dump <weva_dump.exe> --width 800 --height 600 --chrome-metrics --out-dir .utmp/grid-regressions
```
