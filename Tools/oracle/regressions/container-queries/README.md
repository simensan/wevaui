...
```powershell
node Tools/Layout/capture-all-chrome-layouts.mjs Tools/oracle/regressions/container-queries 800 600 --metrics=mono
python Tools/oracle/chrome_sweep.py Tools/oracle/regressions/container-queries --weva-dump <weva_dump.exe> --width 800 --height 600 --chrome-metrics --out-dir .utmp/container-regressions
```
