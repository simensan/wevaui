...
const CHROME = path.resolve(process.cwd(), '..', '..', 'Assets', 'UI', 'settings.html.chrome-layout.json');
const UNITY  = path.resolve(process.cwd(), '..', '..', 'Assets', 'UI', 'settings.unity-layout.json');
