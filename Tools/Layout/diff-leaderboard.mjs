...
const CHROME = path.resolve(process.cwd(), '..', '..', 'Assets', 'UI', 'leaderboard.html.chrome-layout.json');
const UNITY  = path.resolve(process.cwd(), '..', '..', 'Assets', 'UI', 'leaderboard.unity-layout.json');
