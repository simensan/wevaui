...
// Drives menu.html. Attach to the same GameObject as a WevaLegacyDocument; we wire
// ourselves in OnEnable via WevaLegacyDocument.SetController. The {{ CoinCount }} text
