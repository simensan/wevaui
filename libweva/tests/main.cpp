...
int main() {
    ...
    test_abi_failed_load_keeps_document();
    test_abi_load_then_pointer_before_update();
    test_abi_removed_element_is_not_hit();
    test_abi_snap_state_forgets_removed_container();
    test_abi_textures_survive_viewport_change();
    test_abi_select_word_in_disabled_field();
    test_abi_getters_clear_buffer_on_miss();
    test_abi_asset_reader_impossible_size();
    test_hostile_html_depth();
    test_hostile_formatting_elements();
    test_hostile_selector_nesting();
    test_hostile_value_nesting();
    test_hostile_var_expansion();
    test_hostile_nth_coefficients();
